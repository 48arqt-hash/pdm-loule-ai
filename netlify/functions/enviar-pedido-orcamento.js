...
export const handler = async (event) => {
  ...
  try {
    const { name, email, phone, description, includeViability, documents = [] } = JSON.parse(event.body || '{}');
