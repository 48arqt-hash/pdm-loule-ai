...
export const handler = async (event) => {
  ...
  try {
    const { date, time, name, phone, email, context, privacyConsent, privacyPolicyVersion } = JSON.parse(event.body || '{}');
