...
export const handler = async (event) => {
  ...
  try {
    ...
    const feesLow = Math.max(8000, worksLow * 0.05); const feesHigh = Math.max(8000, worksHigh * 0.08);
