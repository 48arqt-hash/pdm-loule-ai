...
export const MUNICIPAL_DATA = {
  loule: {
    ...
    regras: {
      ...
      'area de edificacao dispersa a estruturar': [
        { elemento: 'Enquadramento da categoria', resultado: 'Espaço urbanizável delimitado na carta de ordenamento, já dotado de algumas infraestruturas urbanas ou a dotar durante a vigência do Plano. A Câmara prevê a sua estruturação urbana e a execução de infraestruturas através de planos municipais de ordenamento do território.', artigo: 'Artigos 26.º e 27.º, n.º 1', pagina: '15' },
        { elemento: 'Parâmetros de estruturação', resultado: 'Densidade populacional máxima de 50 habitantes por hectare e coeficiente de ocupação do solo (COS) máximo de 0,20.', artigo: 'Artigo 27.º, n.º 2', pagina: '15' },
        { elemento: 'Construção isolada - condições', resultado: 'Em casos pontuais, sem prejudicar a futura estruturação, pode ser licenciada ou sujeita a comunicação prévia construção isolada para habitação, comércio/serviços, restauração e bebidas, indústria compatível com uso habitacional e equipamentos, desde que exista acesso por via pública estruturada ou estruturável.', artigo: 'Artigo 27.º, n.º 3.2, alínea a)', pagina: '15' },
        { elemento: 'Construção isolada - limites', resultado: 'Área máxima de implantação de 300 m²; área máxima de construção de 450 m²; máximo de 2 pisos acima da cota de soleira ou 6,5 m de altura; afastamento mínimo de 5 m aos extremos, sem prejuízo de regras de vias e alinhamentos.', artigo: 'Artigo 27.º, n.º 3.2, alíneas b), c) e d)', pagina: '15' },
        { elemento: 'Infraestruturas e espaço exterior', resultado: 'Exige redes públicas de abastecimento de água e drenagem de esgotos; muros e arranjos exteriores sujeitos a projeto, com afastamento mínimo de 4,5 m ao eixo da via e atenção aos alinhamentos e à estruturação viária.', artigo: 'Artigo 27.º, n.º 3.2, alíneas f) e g)', pagina: '15' },
      ],
